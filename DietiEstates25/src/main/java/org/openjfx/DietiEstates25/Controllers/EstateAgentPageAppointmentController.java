...
public class EstateAgentPageAppointmentController {
    ...
    private void loadAppointment() {
		...
		try {
			for (int i = 0; i < 10; i++) {
				if(i%2==0) {
					FXMLLoader loader = new FXMLLoader(WindowsManager.class.getResource("FXMLFiles/Objects/AppointmentObject.fxml"));
					root = loader.load();
				}
				else {
					FXMLLoader loader = new FXMLLoader(WindowsManager.class.getResource("FXMLFiles/Objects/AppointmentObject-Alternative.fxml"));
					root = loader.load();
				}
